-- First, fix the null user_id values in posts table
-- We'll set them to a default system user or remove them

-- Check current data and clean up null user_ids
...
-- Users table policies - link to auth.users
